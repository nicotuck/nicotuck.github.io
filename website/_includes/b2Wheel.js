// import * as Two from 'https://cdnjs.cloudflare.com/ajax/libs/two.js/0.8.10/two.min.js';
// import * as b2 from '../assets/javascript/box2d.umd.js';
...
// Set up Box2d
const gravity = new b2.Vec2(0, 9.81);
const world = new b2.World(gravity);

// Set up the wheel
const wheelRadius = 1;
const wheelBodyDef = new b2.BodyDef();
wheelBodyDef.type = b2.BodyType.b2_dynamicBody;
